function ML_features = get_supervised_features(mocapstruct,framelist,markersetind,ratname,savename,overwrite_savefile,overwrite_coeff)
...
if (exist(savefilename,'file') && ~overwrite_savefile)
    fprintf('loading ML features from file \n')
    load(savefilename)
else
