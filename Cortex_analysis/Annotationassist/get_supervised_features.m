function MLmatobj = get_supervised_features(mocapstruct,framelist,markersetind,ratname,savename,overwrite_savefile,overwrite_coeff)


%% local pose/dynamics features
% load saved eigenposture feature coefficients and dynamics coefficients
eigenposture_save_folder = '\\10.242.62.28\olveczky_lab\Jesse\Data\Annotation\Eigenposture_coefficients';
condition_mlfeatures_save_folder = '\\10.242.62.28\olveczky_lab\Jesse\Data\Annotation\condition_mlfeatures';
...
savefilename = strcat(condition_mlfeatures_save_folder,filesep,savename,'.mat');
