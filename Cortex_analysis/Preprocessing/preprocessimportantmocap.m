...
if numel(descriptor_struct)
 ...
 [mocapstruct_v8pl2] = preprocess_mocap_data_2(mocapfilearray,mocapfilestruct,descriptor_struct,mocapfiletimes,1,1,[],mocapvideodirectory,1);
 end
end
end
end